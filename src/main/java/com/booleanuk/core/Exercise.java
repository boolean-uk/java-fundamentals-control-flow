...
public class Exercise {
    ...
    public int eleven(String sentence) {
        return sentence.contains("milk") && !sentence.contains("coffee") ? 3 : sentence.contains("coffee") && !sentence.contains("milk") ? 6 : sentence.contains("coffee") && sentence.contains("milk") ? 9 : 0;
    }
    ...
    public boolean twelve(int num, int lower, int upper) {
        return (num > lower || num == lower) && (num < upper || num == upper);
    }
