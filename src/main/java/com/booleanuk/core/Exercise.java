...
public class Exercise {
    ...
    public int eleven(String sentence) {
        int num=0;
        if (sentence.contains("milk")) num= 3;
        if (sentence.contains("coffee")) num= 6;
        if (sentence.contains("coffee") & sentence.contains("milk")) num= 9;
        return num;
    ...
    public String thirteen(int age) {
        ...
        else if (age>=13 & age <20) return "Teenager";
