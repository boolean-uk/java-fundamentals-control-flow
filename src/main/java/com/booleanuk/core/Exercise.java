...
public class Exercise {
    ...
    public String eight(int numOne, int numTwo) {
        String res = (numOne>=numTwo)? "Correct!":"Wrong!";
        return res;
    }
    ...
    public boolean nine(int[] nums) {
       boolean res = (nums.length>0)? true:false;
       return res;
    }
    ...
    public boolean ten(String sentence) {
        return sentence.toLowerCase().contains("milk");
    }
    ...
    public int eleven(String sentence) {
       if(sentence.toLowerCase().contains("milk")){
           if(sentence.toLowerCase().contains("coffee")){
               return 9;
           }else {
               return 3;
           }
       }else if(sentence.toLowerCase().contains("coffee")){
           return 6;
       }
       else{
           return 0;
