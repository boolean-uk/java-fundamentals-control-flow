...
public class Extension extends ExtensionBase {
	...
	public String timerStatus (int min){
		...
		if (min < 0) return "The timer finished ages ago!";
     ...
     */
		public int estimatePrepTime(String[] ingr,int min){
			if (min==0) min=2;
			return  ingr.length*min;
		}
	...
	public int calculateGramsOfSugar (String[] ingr,int layers){
