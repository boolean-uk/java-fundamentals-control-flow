...
public class Extension extends ExtensionBase {
    ...
    public boolean containsIngredient(String[] ingredients, String compareIngredient) {
        for (String ingredient : ingredients)
            if (ingredient.equals(compareIngredient)) return true;
        return false;
    }

    public int calculateGramsOfSugar(String[] ingredients, int cakeLayers) {
        return cakeLayers * 100 * (containsIngredient(ingredients, "sugar") ? 1 : 0);
    }
