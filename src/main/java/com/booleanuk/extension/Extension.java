...
public class Extension extends ExtensionBase {
     ...
     * and "The timer finished ages ago!" if the remaining minutes is a negative
     * number
     */
     ...
     * 
     * The method must return the total prep time required based on the number of
     * ingredients
     * provided and the prep time per ingredient.
     * If a prep time of 0 is provided, the method should assume each ingredient
    ...
    public int estimatePrepTime(String[] ingredients, int prepTimePerIngredient) {
        ...
        if (prepTimePerIngredient == 0) {
            prepTime = ingredients.length * 2;
        } else {
            prepTime = ingredients.length * prepTimePerIngredient;
        }
        return prepTime;
    }
     ...
     * 
     * The cake will need 100g of sugar per layer, if that ingredient is present in
     * the provided list of ingredients
     * and 0g if that ingredient is missing.
     * The method should return the number of grams of sugar needed to make the
     * cake.
     * 
