...
public class Extension extends ExtensionBase {
     ...
     */
    public int estimatePrepTime(String[] ingredients, int minutesPerIngredient) {
        if(minutesPerIngredient == 0) {
            minutesPerIngredient = 2;
        }
        return ingredients.length * minutesPerIngredient;
    }
